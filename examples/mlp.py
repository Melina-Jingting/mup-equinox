...
class MLP(eqx.Module):
    ...
    def get_activations(self, x, *, layer_keys: list[str] | str | None = None):
        activations = {}
...
model, state, metadata = training_cfg.model_factory.build(training_cfg.width_multiplier)
optimizer = training_cfg.optimizer_factory.build(metadata)
